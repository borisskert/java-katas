...
public class IntervalTest {
    ...
    @Test
    public void shouldHandleMaximumIntervals() {
        assertEquals(2147483646, sumIntervals(new int[][]{{1, 2147483647}}));
    }

    @Test
    public void mergeDeepOverlappingIntervals() {
        Interval.MyInterval first = Interval.MyInterval.createFrom(new int[]{1, 3});
        Interval.MyInterval second = Interval.MyInterval.createFrom(new int[]{2, 5});

        assertEquals(true, first.isMergeableWith(second));

        Interval.MyInterval merged = first.mergeWith(second);
        assertEquals(1, merged.getStart());
        assertEquals(5, merged.getEnd());
    }

    @Test
    public void mergeOverlappingIntervals() {
        Interval.MyInterval first = Interval.MyInterval.createFrom(new int[]{1, 3});
        Interval.MyInterval second = Interval.MyInterval.createFrom(new int[]{3, 5});
    ...
    @Test
    public void shouldNotMergeTouchingIntervals() {
        Interval.MyInterval first = Interval.MyInterval.createFrom(new int[]{1, 3});
        Interval.MyInterval second = Interval.MyInterval.createFrom(new int[]{4, 5});

        assertEquals(false, first.isMergeableWith(second));
    }

    @Test
    public void mergeIncludingIntervals() {
        Interval.MyInterval first = Interval.MyInterval.createFrom(new int[]{1, 5});
        Interval.MyInterval second = Interval.MyInterval.createFrom(new int[]{2, 4});
    ...
    public void mergeSameIntervals() {
        Interval.MyInterval first = Interval.MyInterval.createFrom(new int[]{1, 5});
        Interval.MyInterval second = Interval.MyInterval.createFrom(new int[]{1, 5});
    ...
    public void shouldNotBeMergeable() {
        Interval.MyInterval first = Interval.MyInterval.createFrom(new int[]{1, 2});
        Interval.MyInterval second = Interval.MyInterval.createFrom(new int[]{4, 5});
