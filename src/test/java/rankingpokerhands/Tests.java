...
public class Tests {
    ...
    @Test
    public void randomizedTests() throws Exception {
        Test("High card Jack wins", win, "TC 8C 2S JH 6C", "2D 6D 9D TH 7D");
        Test("Three of a kind should win with high card wins", win, "7C 7S KH 2H 7H", "7C 7S 3S 7H 5S");
        Test("Second high card King wins", win, "KD 6S 9D TH AD", "JH 8S TH AH QH");
    }

    @Test
    public void failingTests() throws Exception {
        Test("", loss, "5S 5D 2C KH KC", "3C KH 5D 5S KC");
    }
}
