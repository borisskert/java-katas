...
class IndexedBinaryTreeTest {

    IndexedBinaryTree<Integer> tree;
    ...
    @Test
    public void shouldAddFiveHundredNumbers() throws Exception {
        int count = 500;
        ...
        for (int counter = 0; counter < count; counter++) {
            assertThat(tree.contains(counter)).isEqualTo(true);
            assertThat(tree.get(counter)).isEqualTo(counter);
        }
    }

    @Test
    public void shouldAddFiveHundredDuplicateNumbers() throws Exception {
        int count = 500;
    ...
    public void shouldFindFailingSetup() throws Exception {
        ...
        for (int tryCounter = 0; tryCounter < tries; tryCounter++) {
            IndexedBinaryTree<Integer> myTree = new IndexedBinaryTree<>();
